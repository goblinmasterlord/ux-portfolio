...
import { Menu, X, ChevronDown, ArrowRight, ChevronRight, Github, Twitter, Linkedin, Mail } from 'lucide-react';
          ...
          <div className={`relative rounded-2xl transition-all duration-300 ${isScrolled
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/" className="text-2xl font-display font-bold text-primary tracking-tight z-50 relative">
                marci<span className="text-accent">.ux</span>
              </Link>
                  ...
                  <AnimatePresence>
                    {isProjectsOpen && (
                      <motion.div
                        ...
                        className="absolute top-full right-0 mt-2 w-[600px] bg-[#0a0a0a] border border-white/10 rounded-2xl shadow-2xl overflow-hidden p-2 grid grid-cols-2 gap-2 origin-top-right"
                      >
                        {/* Project List */}
                        ...
                        {/* Preview Image */}
                        <div className="relative rounded-xl overflow-hidden bg-surface aspect-[4/3]">
                          ...
                          <div className="absolute bottom-4 left-4">
                            <span className="px-2 py-1 rounded bg-accent/20 text-accent text-xs font-mono border border-accent/20">
                              Case Study
                            </span>
                          </div>
                        </div>
